...
import { Video, Calendar, Clock, ExternalLink, Play, MapPin, ChevronLeft, Plus, Settings, ClipboardCheck, CheckCircle2, Star, X, Info } from 'lucide-react';
...
export default function SessionsList() {
  ...
  const isSessionUpcoming = (session: Session) => {
    return Date.now() < new Date(session.date).getTime();
  };
              ...
              <div className="p-8 flex flex-col md:flex-row gap-8 items-start relative z-10">
                ...
                <div className="md:self-center">
                  {isSessionFinished(session) ? (
                    ...
                    <div className="bg-surface-container-high/50 text-on-surface-variant/40 px-6 py-4 rounded-2xl font-black uppercase tracking-widest text-xs flex items-center gap-2 border border-outline-variant/5">
                       <Clock size={16} />
